  ...
  return (
    <div className="min-h-screen" style={{ background: "#faf8f4" }}>
      <style>{`
        ...
        .gold-line { width: 40px; height: 1px; background: #b8976a; }
      ...
      <div className="font-body text-center py-2.5 text-xs tracking-wide" style={{ background: "#2c2418", color: "rgba(255,255,255,0.7)" }}>
      ...
      <nav className="sticky top-0 z-50 transition-all duration-300" style={{
        ...
        <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <div className="font-display text-xl font-bold" style={{ color: "#2c2418" }}>Osteria il Bertoldo</div>
              <div className="font-body text-[10px] uppercase tracking-[0.2em]" style={{ color: "#a08b6e" }}>Verona &middot; Dal 1988</div>
            </div>
          </a>

          <div className="hidden md:flex items-center gap-8">
            <a href="#storia" className="font-body text-sm hover:opacity-60 transition-opacity" style={{ color: "#6b5c4a" }}>La storia</a>
            <a href="#menu" className="font-body text-sm hover:opacity-60 transition-opacity" style={{ color: "#6b5c4a" }}>Menu</a>
            <a href="#galleria" className="font-body text-sm hover:opacity-60 transition-opacity" style={{ color: "#6b5c4a" }}>Galleria</a>
            <a href="#contatti" className="font-body text-sm hover:opacity-60 transition-opacity" style={{ color: "#6b5c4a" }}>Contatti</a>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
        ...
        {mobileMenu && (
          <div className="md:hidden font-body px-6 py-5 space-y-1" style={{ background: "#faf8f4", borderTop: "1px solid rgba(44,36,24,0.06)" }}>
            {["La storia", "Menu", "Galleria", "Contatti"].map((l) => (
              <a key={l} href={`#${l.toLowerCase().replace(" ", "")}`} onClick={() => setMobileMenu(false)} className="block py-3 text-sm font-medium" style={{ color: "#6b5c4a", borderBottom: "1px solid rgba(44,36,24,0.04)" }}>{l}</a>
            ))}
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="block text-center mt-3 px-6 py-3.5 rounded-full text-white font-semibold text-sm" style={{ background: "#6b4226" }}>
              Prenota un tavolo
            </a>
          </div>
        )}
      ...
      <section className="px-6 pt-10 pb-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 fade-up">
            ...
            <h1 className="font-display text-5xl sm:text-7xl font-bold leading-[1.05] mb-5" style={{ color: "#2c2418" }}>
              Benvenuti all&apos;Osteria<br />il Bertoldo
            </h1>
            <p className="font-body text-lg max-w-xl mx-auto leading-relaxed" style={{ color: "#8a7a65" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 font-body">
            ...
            <a href={`tel:${TELEFONO}`} className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-base font-medium transition-all hover:opacity-80" style={{ color: "#6b4226", border: "1.5px solid #6b4226" }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b4226" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
              Chiamaci
            </a>
          </div>
        </div>
      ...
      {/* NUMERI */}
      <section className="py-16 px-6" style={{ background: "#2c2418" }}>
        <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={s.label}>
              <div className="font-display text-3xl sm:text-4xl font-bold" style={{ color: "#c4a97d" }}>{s.num}</div>
      ...
      <section id="lastoria" className="py-28 px-6">
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#b8976a" }}>La nostra storia</p>
            <h2 className="font-display text-3xl sm:text-4xl font-bold mb-6 leading-tight" style={{ color: "#2c2418" }}>
              Tradizione e passione dal 1988
            </h2>
            <p className="font-body text-base leading-[1.8] mb-6" style={{ color: "#6b5c4a" }}>
            ...
            <p className="font-body text-base leading-[1.8] mb-8" style={{ color: "#6b5c4a" }}>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: "rgba(107,66,38,0.08)" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b4226" strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
              </div>
              <p className="font-body text-sm italic" style={{ color: "#a08b6e" }}>
      ...
      {/* MENU / SPECIALITA */}
      <section id="menu" className="py-28 px-6" style={{ background: "#f0ebe1" }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <div className="gold-line mx-auto mb-8" />
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#b8976a" }}>I nostri piatti</p>
            <h2 className="font-display text-3xl sm:text-5xl font-bold mb-3" style={{ color: "#2c2418" }}>Specialita della casa</h2>
            <p className="font-body text-sm" style={{ color: "#a08b6e" }}>Piatti preparati ogni giorno con ingredienti freschi e di stagione</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {piatti.map((p, i) => (
              <div key={i} className="rounded-2xl p-7 hover-lift" style={{ background: "#faf8f4" }}>
                <div className="flex items-center gap-3 mb-3">
                  <span className="font-body text-[10px] uppercase tracking-widest font-semibold px-3 py-1 rounded-full" style={{ background: "rgba(184,151,106,0.12)", color: "#b8976a" }}>{p.cat}</span>
                </div>
                <h3 className="font-display text-xl font-bold mb-2" style={{ color: "#2c2418" }}>{p.nome}</h3>
                <p className="font-body text-sm leading-relaxed" style={{ color: "#8a7a65" }}>{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="galleria" className="py-28 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <div className="gold-line mx-auto mb-8" />
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#b8976a" }}>Il nostro mondo</p>
            <h2 className="font-display text-3xl sm:text-5xl font-bold" style={{ color: "#2c2418" }}>Galleria</h2>
          </div>
      ...
      {/* PRENOTAZIONE CTA */}
      <section className="py-24 px-6" style={{ background: "#2c2418" }}>
        <div className="max-w-3xl mx-auto text-center">
          <div className="gold-line mx-auto mb-8" />
          <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#c4a97d" }}>Prenotazioni</p>
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-12 font-body">
            {[
              ...
              <div key={s.num} className="text-center">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold" style={{ background: "#c4a97d", color: "#2c2418" }}>{s.num}</div>
      ...
      {/* RECENSIONI */}
      <section className="py-28 px-6" style={{ background: "#f0ebe1" }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <div className="gold-line mx-auto mb-8" />
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#b8976a" }}>Recensioni</p>
            <h2 className="font-display text-3xl sm:text-4xl font-bold" style={{ color: "#2c2418" }}>Cosa dicono i nostri ospiti</h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {recensioni.map((r, i) => (
              <div key={i} className="rounded-2xl p-7 hover-lift" style={{ background: "#faf8f4" }}>
                <div className="flex gap-0.5 mb-4">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <svg key={s} width="16" height="16" viewBox="0 0 24 24" fill="#c4a97d"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                  ))}
                </div>
                <p className="font-body text-sm leading-[1.8] mb-5" style={{ color: "#6b5c4a" }}>&ldquo;{r.testo}&rdquo;</p>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-full flex items-center justify-center font-body text-xs font-bold" style={{ background: "rgba(184,151,106,0.15)", color: "#b8976a" }}>
                    {r.nome.charAt(0)}
                  </div>
                  <div>
                    <div className="font-body text-sm font-semibold" style={{ color: "#2c2418" }}>{r.nome}</div>
                    <div className="font-body text-xs" style={{ color: "#a08b6e" }}>{r.citta}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl p-10 sm:p-14 text-center" style={{ background: "linear-gradient(135deg, #f0ebe1 0%, #faf8f4 100%)", border: "1px solid rgba(184,151,106,0.2)" }}>
            <div className="gold-line mx-auto mb-6" />
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-3" style={{ color: "#b8976a" }}>Idea regalo</p>
            <h2 className="font-display text-2xl sm:text-3xl font-bold mb-3" style={{ color: "#2c2418" }}>Buoni Regalo</h2>
            <p className="font-body text-sm mb-8" style={{ color: "#8a7a65" }}>
            ...
            <div className="flex flex-wrap justify-center gap-3 font-body">
              {["50", "100", "150", "200"].map((v) => (
                <span key={v} className="px-6 py-3 rounded-full text-sm font-semibold hover-lift cursor-default" style={{ background: "#faf8f4", color: "#6b4226", border: "1px solid rgba(184,151,106,0.25)", boxShadow: "0 2px 8px rgba(44,36,24,0.04)" }}>
                  {v}&euro;
                </span>
              ))}
            </div>
      ...
      {/* CONTATTI + MAPPA */}
      <section id="contatti" className="py-28 px-6" style={{ background: "#2c2418" }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <div className="gold-line mx-auto mb-8" />
            <p className="font-body text-xs uppercase tracking-[0.3em] mb-4" style={{ color: "#c4a97d" }}>Vieni a trovarci</p>
            ...
            <div className="space-y-3">
              <a href={`https://maps.google.com/?q=${encodeURIComponent(INDIRIZZO)}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-5 rounded-xl transition-all hover:opacity-80" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(196,169,125,0.12)" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c4a97d" strokeWidth="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                </div>
                <div>
              ...
              <a href={`tel:${TELEFONO}`} className="flex items-center gap-4 p-5 rounded-xl transition-all hover:opacity-80" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(196,169,125,0.12)" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c4a97d" strokeWidth="1.5"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
                </div>
                <div>
              ...
              <a href={`mailto:${EMAIL}`} className="flex items-center gap-4 p-5 rounded-xl transition-all hover:opacity-80" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(196,169,125,0.12)" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c4a97d" strokeWidth="1.5"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4 p-5 rounded-xl" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: "rgba(196,169,125,0.12)" }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c4a97d" strokeWidth="1.5"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg>
                </div>
                <div>
              ...
              <div className="flex gap-3 pt-4">
                {[
                  ...
                  <a key={i} href={s.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all hover:opacity-70" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.08)", color: "#c4a97d" }}>
                    {s.icon}
                  </a>
                ))}
              </div>
      ...
      {/* FOOTER */}
      <footer className="py-10 px-6 font-body" style={{ background: "#201b13" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs" style={{ borderTop: "1px solid rgba(255,255,255,0.05)", color: "rgba(255,255,255,0.2)" }}>
            ...
            <span>
              Prenotazioni by <a href="https://getreservi.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity" style={{ color: "#c4a97d" }}>Reservi</a>
            </span>
          </div>
        </div>
      </footer>
